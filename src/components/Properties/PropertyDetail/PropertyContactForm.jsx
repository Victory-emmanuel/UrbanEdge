      ...
      {isSubmitted ? (
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-brown-dark dark:text-beige-light mb-1">
                Your Name*
              </label>
              <input
                type="text"
            ...
            {formType === "tour" && (
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="tourDate" className="block text-sm font-medium text-brown-dark dark:text-beige-light mb-1">
                    Preferred Date*
                  </label>
                  <input
                    type="date"
                ...
                <div>
                  <label htmlFor="tourTime" className="block text-sm font-medium text-brown-dark dark:text-beige-light mb-1">
                    Preferred Time*
                  </label>
                  <select
                    id="tourTime"
            ...
            <div>
              <label htmlFor="message" className="block text-sm font-medium text-brown-dark dark:text-beige-light mb-1">
                Message
              </label>
              <textarea
                id="message"
