  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        ...
        {/* Down Payment */}
        <div>
          <label htmlFor="downPayment" className="block text-sm font-medium text-brown-dark dark:text-beige-light mb-1">
            Down Payment
          </label>
          <input
            type="number"
          ...
          <div className="mt-2 flex justify-between text-xs text-brown dark:text-beige-medium">
            <span>{Math.round((downPayment / propertyPrice) * 100)}% of property price</span>
        ...
        {/* Loan Amount */}
        <div>
          <label htmlFor="loanAmount" className="block text-sm font-medium text-brown-dark dark:text-beige-light mb-1">
            Loan Amount
          </label>
          <input
            type="number"
        ...
        {/* Interest Rate */}
        <div>
          <label htmlFor="interestRate" className="block text-sm font-medium text-brown-dark dark:text-beige-light mb-1">
            Interest Rate (%)
          </label>
          <input
            type="number"
        ...
        {/* Loan Term */}
        <div>
          <label htmlFor="loanTerm" className="block text-sm font-medium text-brown-dark dark:text-beige-light mb-1">
            Loan Term (years)
          </label>
          <select
            id="loanTerm"
        ...
        <p className="text-xs text-brown dark:text-beige-medium italic">
          This calculator is for estimation purposes only. Contact a mortgage professional for accurate rates and terms.
        </p>
      </div>
    </motion.div>
  );
