...
const AdminDashboard = () => {
  ...
  const handleToggleAdminStatus = async (userId, currentStatus) => {
    try {
      const { error } = await userService.setUserAdminStatus(userId, !currentStatus);
      if (error) throw error;
                ...
                <tbody>
                  {properties.map((property) => (
                    <tr key={property.id} className="hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4 border-b">{property.property_type?.name}</td>
                      <td className="py-3 px-4 border-b">{property.sale_type?.name}</td>
              ...
              <table className="min-w-full bg-white border border-gray-200">
                <thead>
                  <tr>
                    ...
                    <th className="py-3 px-4 border-b text-left">Admin Status</th>
