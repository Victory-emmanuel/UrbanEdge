...
const faqs = [
  {
    ...
    answer: "You can schedule a property viewing by contacting us through our website, calling our office directly, or emailing the specific agent listed on the property page. We offer both in-person and virtual tours to accommodate your preferences and schedule.",
  },
  {
    question: "What documents do I need to apply for a property?",
    answer: "To apply for a property, you'll typically need proof of identity (government-issued ID), proof of income (pay stubs, tax returns, or bank statements), employment verification, rental history, and references. Specific requirements may vary depending on the property and situation.",
  },
  {
  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        {faqs.map((faq, index) => (
          <div key={index} className="border border-beige-medium dark:border-brown rounded-lg overflow-hidden">
            <button
