      ...
      {isSubmitted ? (
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Service */}
            <div className="md:col-span-1">
              <label htmlFor="service" className="block text-sm font-medium text-brown-dark dark:text-beige-light mb-1">
            ...
            <div className="md:col-span-2">
              <label htmlFor="subject" className="block text-sm font-medium text-brown-dark dark:text-beige-light mb-1">
                Subject*
              </label>
              <input
                type="text"
