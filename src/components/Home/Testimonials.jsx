...
const testimonials = [
  {
    ...
    quote: "UrbanEdge made finding our dream home an absolute pleasure. Our agent was knowledgeable, responsive, and truly understood what we were looking for. We couldn't be happier with our new home!",
    rating: 5,
  },
  {
    id: 2,
    ...
    quote: "As an investor, I appreciate UrbanEdge's market insights and attention to detail. They've helped me acquire multiple high-performing properties and their property management services are exceptional.",
    rating: 5,
  },
  {
    id: 3,
    ...
    quote: "Selling our first home was daunting, but UrbanEdge guided us through every step. Their marketing strategy attracted multiple offers, and we sold above asking price in just two weeks!",
    rating: 5,
  },
  {
    id: 4,
    ...
    quote: "The level of service and attention to detail at UrbanEdge is unmatched. They found us a stunning property that wasn't even on the market yet and negotiated a deal that exceeded our expectations.",
    rating: 4,
  },
  {
    id: 5,
    ...
    quote: "UrbanEdge's commercial team helped us find the perfect location for our expanding business. Their knowledge of zoning regulations and future development plans in the area was invaluable.",
    rating: 5,
  },
];
