...
const features = [
  {
    ...
    description: "With over 20 years of experience, our team of professionals provides unmatched real estate knowledge and personalized service.",
  },
  {
    icon: (
      <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: "Access to exclusive listings in the most desirable locations, from luxury homes to high-potential investment opportunities.",
  },
  {
    icon: (
      <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: "We handle every detail from search to closing, making your real estate journey smooth, efficient, and stress-free.",
  },
  {
    icon: (
      <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: "Our client-first approach means you'll have a dedicated agent available to answer questions and provide guidance at every step.",
  },
];
