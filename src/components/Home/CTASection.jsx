    ...
    <section className="py-12 xs:py-16 sm:py-20 relative">
      ...
      <div className="container mx-auto px-2 xs:px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            Let our expert team guide you through the process and help you discover exceptional properties that match your lifestyle and investment goals.
          </motion.p>
          ...
          >
            ...
            <a href="/contact" className="btn bg-white text-brown-dark hover:bg-beige-light text-xs xs:text-sm sm:text-base">
              Contact an Agent
            </a>
          </motion.div>
        </div>
