...
const blogPosts = [
  {
    ...
    excerpt: "Navigating the real estate market as a first-time buyer can be challenging. Here are our top tips to help you make informed decisions.",
    ...
    <section className="py-16 bg-beige-light dark:bg-brown">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-8 xs:mt-10 sm:mt-12">
          <a href="/blog" className="btn-outline text-xs xs:text-sm sm:text-base">
