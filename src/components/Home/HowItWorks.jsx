...
const steps = [
  {
    ...
    description: "Browse our curated selection of premium properties or use our advanced search to find exactly what you're looking for.",
  ...
  },
  {
    ...
    description: "Our experienced agents will guide you through the process, arrange viewings, and provide expert advice tailored to your needs.",
  ...
  },
  {
    ...
    description: "From offer to closing, we handle the negotiations, paperwork, and logistics to ensure a smooth and successful transaction.",
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              >
                ...
                {index === 0 && (
                  <a href="/properties" className="btn-primary text-xs xs:text-sm sm:text-base">
                    Browse Properties
                  </a>
                )}
                {index === 1 && (
                  <a href="/about#team" className="btn-primary text-xs xs:text-sm sm:text-base">
                    Meet Our Agents
                  </a>
                )}
                {index === 2 && (
                  <a href="/contact" className="btn-primary text-xs xs:text-sm sm:text-base">
                    Get Started
                  </a>
                )}
              </motion.div>
