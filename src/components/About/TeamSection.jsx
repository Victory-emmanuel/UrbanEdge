...
const teamMembers = [
  {
    ...
    expertise: ["Luxury Properties", "Commercial Real Estate", "Investment Strategy"],
  ...
  },
  {
    ...
    expertise: ["Operations Management", "Process Optimization", "Technology Integration"],
  ...
  },
  {
    ...
    expertise: ["Investment Analysis", "Portfolio Management", "Rental Properties"],
  ...
  },
  {
    ...
    expertise: ["Client Experience", "Relationship Management", "Process Coordination"],
                    ...
                    <div className="p-6">
                      ...
                      <div className="mb-4 space-y-2">
                        <div className="flex items-center text-brown dark:text-beige-medium">
                          ...
                          <a href={`mailto:${selectedMember.email}`} className="hover:text-taupe transition-colors">
                            {selectedMember.email}
                          </a>
                        </div>
                        <div className="flex items-center text-brown dark:text-beige-medium">
                          <PhoneIcon className="h-5 w-5 mr-2" />
                          <a href={`tel:${selectedMember.phone}`} className="hover:text-taupe transition-colors">
