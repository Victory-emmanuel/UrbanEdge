...
const testimonials = [
  {
    ...
    quote: "The buying process was seamless with UrbanEdge. Our agent took the time to understand exactly what we were looking for and found us the perfect home within our budget. Their negotiation skills saved us thousands!",
    rating: 5,
  },
  {
    id: 2,
    ...
    quote: "UrbanEdge's investment advisory team helped me build a real estate portfolio that has consistently outperformed the market. Their market analysis and property recommendations have been spot on.",
    rating: 5,
  },
  {
    id: 3,
    ...
    quote: "I was amazed at how quickly UrbanEdge sold my property and for above asking price! Their marketing strategy and professional photography made my home stand out in a competitive market.",
    rating: 5,
  },
  {
    id: 4,
    ...
    quote: "Since switching to UrbanEdge for property management, my rental income has increased and tenant issues have decreased. Their team is responsive, professional, and truly cares about maximizing my investment.",
    rating: 4,
  },
  {
    id: 5,
    ...
    quote: "UrbanEdge guided our development project from concept to completion with exceptional expertise. Their knowledge of zoning regulations and relationships with local officials were invaluable in navigating the approval process.",
    rating: 5,
  },
];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-brown dark:text-beige-medium">
            Hear from clients who have experienced the UrbanEdge difference across our range of services.
          </p>
        </motion.div>
                ...
                >
                  <div className="bg-white dark:bg-brown-dark rounded-lg shadow-md p-6 h-full flex flex-col">
                    ...
                    <blockquote className="mb-6 flex-grow">
                      <p className="italic text-brown dark:text-beige-medium">"{testimonial.quote}"</p>
                    </blockquote>
