...
const faqs = [
  {
    ...
    answer: "UrbanEdge primarily serves major metropolitan areas across the United States, with a focus on luxury and high-end properties. Our main offices are located in New York, Los Angeles, Miami, and Chicago, but we have partner agents in many other cities. For specific location inquiries, please contact our team.",
  },
  {
  ...
  },
  {
    ...
    answer: "Our property management services stand out through our proactive approach, technology integration, and personalized attention. We maintain a lower property-to-manager ratio than industry standards, ensuring your investment receives proper attention. Our proprietary software provides real-time reporting and maintenance tracking, while our tenant screening process results in longer tenancies and fewer issues.",
  },
  {
    question: "How do you determine the right listing price for my property?",
    answer: "We determine the optimal listing price through a comprehensive comparative market analysis (CMA) that examines recent sales of similar properties, current market conditions, property-specific features, and neighborhood trends. Our pricing strategy also considers your timeline and goals. We provide a detailed pricing report and explain our recommendations before finalizing the listing price.",
  },
  {
