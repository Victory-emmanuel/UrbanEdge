...
const services = [
  {
    id: "buying",
    title: "Buying",
    description: "Find your dream property with our expert guidance. We'll help you navigate the market, identify opportunities that match your criteria, and negotiate the best possible terms.",
    icon: (
  ...
  },
  {
    id: "selling",
    title: "Selling",
    description: "Maximize your property's value with our comprehensive selling services. We combine market expertise, innovative marketing strategies, and skilled negotiation to achieve optimal results.",
    icon: (
      <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    id: "renting",
    title: "Renting",
    description: "Whether you're looking to rent a property or need help managing your rental investment, our rental services provide comprehensive solutions tailored to your specific needs.",
    icon: (
      <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: "Maximize the return on your real estate investments while minimizing stress. Our property management services handle every aspect of your rental property, ensuring it performs optimally.",
    icon: (
      <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: "Build wealth through strategic real estate investments. Our advisors analyze market trends, identify high-potential opportunities, and develop customized investment strategies aligned with your goals.",
    icon: (
      <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
      </svg>
    ),
    image: "https://images.unsplash.com/photo-1460472178825-e5240623afd5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2069&q=80",
    features: [
  ...
  },
  {
    ...
    description: "Transform your vision into reality with our comprehensive development services. From site selection to project completion, we provide expert guidance at every stage of the development process.",
    icon: (
      <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
      </svg>
    ),
    image: "https://images.unsplash.com/photo-1503387762-592deb58ef4e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2072&q=80",
    features: [
