  ...
  return (
    <div className="bg-white dark:bg-brown-dark rounded-lg shadow-md p-4 xs:p-5 sm:p-6 flex flex-col h-full">
      ...
      <blockquote className="mb-4 xs:mb-6 flex-grow">
        <p className="italic text-sm xs:text-base text-brown dark:text-beige-medium">"{quote}"</p>
      </blockquote>
      ...
      <div className="flex items-center">
        ...
        <div>
          ...
          <p className="text-xs xs:text-sm text-brown dark:text-beige-medium">{role}</p>
        </div>
      </div>
    </div>
  );
